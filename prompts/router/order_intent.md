...
16. expected_start_time 支持今天下午、明天上午、下周一、本周五、3月20日等自然语言时间；没有说时间时输出 null。
17. 安装订单需要抽取 goods_arrival_status：货没到、还没到、在路上 输出 未到场；货到了、已收到、货物在酒店 输出 已到场；到物流站了、在物流点、待配送 输出 已到物流站。
18. 不要输出 Markdown。
19. 不要输出解释。
