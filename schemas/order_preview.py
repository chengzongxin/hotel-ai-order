...
class OrderItem(BaseModel):
    ...
    category: str | None = Field(default=None, description="商品所属分类。")
    repair_category: str | None = Field(default=None, description="维修等级。")
    related_category: str | None = Field(default=None, description="商品关联品类。")
    related_area: str | None = Field(default=None, description="商品适用区域。")
    fault_phenomenon: str | None = Field(default=None, description="商品绑定的标准故障现象。")
    remark: str | None = Field(default=None, description="商品服务说明或备注。")
